...
func prepopulate(dbConn *gorm.DB) error {
	...
	// todo create drinks
	drinks := []model.Drink{
		{Name: "Coca-Cola", Price: 2.5, Description: "Classic Coke"},
		{Name: "Apple Juice", Price: 3.0, Description: "Freshly pressed apple juice"},
		{Name: "Energy Drink", Price: 3.0, Description: "softdrink"},
		{Name: "Espresso", Price: 2.0, Description: "Strong black coffee"},
	}
